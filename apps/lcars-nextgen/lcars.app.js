...
//returns the x pos to start drawing in order to horizontally center an object
  let getCenterX = function(width){
    return (178-width)/2;
  };
...
// Function to convert hex color to RGB.
  ...
  */
  ...
  let bgLeftFullscreenFull = {
    width : 27, height : 176, bpp : 3,
    transparent: 0,
    buffer : require("heatshrink").decompress(atob("")),
    palette: colorPalette
  };
...
// <link href="https://fonts.googleapis.com/css2?family=Antonio:wght@400;700&display=swap" rel="stylesheet">
  ...
  Graphics.prototype.setFontOswald16 = function() {
    // Actual height 16 (15 - 0)
    return this.setFontCustom(
        atob(''),
        32,
        atob("BAUHCAgNDAMFBQgJBAUEBAgICAgICAgICAgEBAkJCQcPDAsLDAoJDAwFBgwKDgwMCQwLCQoMDA8MDAoFBAU="),
        16|131072
    );
  };

  Graphics.prototype.setFontOswald30 = function() {
    // Actual height 30 (29 - 0)
    return this.setFontCustom(
        atob(''),
        32,
        atob("BgYGDg4WEgMICAsLBQkFChAKDw4PDg8MDw8GBgsMCw4ZDg8PEAwMEBAHCA4LExAQDhAPDgwQDxUODgwJCgk="),
        30|131072
    );
  };

  let federation = {
    width : 128, height : 95, bpp : 3,
    buffer : require("heatshrink").decompress(atob(""))
  };
  ...
  let drawHeading = function(string, offset){
    //draw from x1=35 to x2 = 120
    g.setColor(cWhite);
    g.setFontOswald30();
    g.drawString(string, 35, offset);
  };
  ...
  let drawLogbook = function(){

    // Draw background image
    let offset = settings.fullscreen ? 0 : 24;
    g.drawImage(federation, 35, 45);
    g.drawImage(bgLeftFullscreenFull, 0, offset);
    ...
    // Draw Heading
    drawHeading("LOGS", offset);
    // drawHorizontalBgLine(color1, 25, 120, offset, 4);
    drawHorizontalBgLine(color1, 100, 176, offset, 4);
  };

  let drawStandbyClock = function(){

    // Draw background image
    let offset = settings.fullscreen ? 0 : 24;
    g.drawImage(federation, 25, 5);
    ...
    g.drawString(timeStr, getCenterX(timeWidth), 110);
    ...
    let dayStr = locale.dow(currentDate, true).toUpperCase();
    let date = currentDate.getDate();
    let month = locale.month(currentDate, 1).toUpperCase();
    dayStr = " " + date + " " + month;
    g.drawString(dayStr, 70, 160);
    // g.drawString(date, 140, 120);
    // g.drawString(month, 140, 140);
  };
